...
$q="select * from registration where Email='xyz@gmail.com'";
$z=mysql_query($q);								
		...
		<div class='container-fluid'>
			...
			<div class='row'>
				...
				<div class='form-group col-sm-10'>
					...
					<p>  Below are the posts posted by xyz@gmail.com <br>
							Do come back again to see latest posts by xyz@gmail.com </p>
				</div>
				</div>
			</div>
			...
			<div class='row'>
				...
				<div class='col-sm-10'>
					<?php 
						$q2="select * from post where Email='xyz@gmail.com'";
						$z2=mysql_query($q2);
